...
output: 
  html_document:
    keep_md: true
---
About This is the first project assignment for the Reproducible Research course in Coursera's Data Science specialization track. The purpose of the project was to answer a series of questions using data collected from an activity monitoring devices.
